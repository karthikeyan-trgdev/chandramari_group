                ...
                <div class="row footer-custom-row">
                    <div class="col-12 col-md-6">
                        <div class="footer-widget footer-widget-brand" data-aos="fade-up" data-aos-anchor=".footer-top">
                            <a class="footer-logo" href="index.php" aria-label="Consulo Logo">
                                <img src="assets/img/chandramani-logo-2.png" alt="Chandramari Group" width="250"
                                    height="32" loading="lazy" style="filter: brightness(0) invert(1);">
                            </a>
                            <p class="text text-16">At Chandramari Group, we believe in creating impact through
                                boundless innovation. Our journey is driven by a passion for excellence and a commitment
                                to transform visionary ideas into meaningful realities. </p>
                            <!-- <ul
                    ...
                    <div class="col-12 col-md-6">
                        <div class="footer-widget footer-widget-menu" data-aos="fade-up" data-aos-anchor=".footer-top">
                            ...
                            <ul class="footer-menu list-unstyled">
                                <li>
                                    <a href="index.php" class="text text-16 link" aria-label="About Us">
                                        Home
                                    </a>
                                </li>
                                <li>
                                    <a href="about.php" class="text text-16 link" aria-label="Our Team">
                                        About Us
                                    </a>
                                </li>
                                <li>
                                    <a href="interior_fit_out.php" class="text text-16 link" aria-label="Pricing Plans">
                                        Our Sectors
                                    </a>
                                </li>
                                <li>
                                    <a href="news_events.php" class="text text-16 link" aria-label="Blogs">
                                        Our Events
                                    </a>
                                </li>
                                <li>
                                    <a href="contact.php" class="text text-16 link" aria-label="Blogs">
                                        Contact Us
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="footer-widget footer-widget-menu" data-aos="fade-up" data-aos-anchor=".footer-top">
                            ...
                            <ul class="footer-menu list-unstyled">
                                <li>
                                    <a href="interior_fit_out.php" class="text text-16 link"
                                        aria-label="App Development">
                                        Interior Fit-outs
                                    </a>
                                </li>
                                <li>
                                    <a href="education.php" class="text text-16 link" aria-label="Digital Marketing">
                                        Educational
                                    </a>
                                </li>
                                <li>
                                    <a href="technology.php" class="text text-16 link"
                                        aria-label="Web Development">Technologies</a>
                                </li>
                                <li>
                                    <a href="hospitality.php" class="text text-16 link" aria-label="Cyber Security">
                                        Food & Beverages
                                    </a>
                                </li>

                                <li>
                                    <a href="services.php" class="text text-16 link" aria-label="Cyber Security">
                                        Services
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="footer-widget footer-widget-menu" data-aos="fade-up" data-aos-anchor=".footer-top">
                            ...
                            <ul class="footer-menu list-unstyled">
                                <li>
                                    <a href="mailto:info@toprockinteriors.com" class="text text-16 link" aria-label="Privacy Policy">
                                        Mail ID : info@toprockinteriors.com
                                    </a>
                                </li>
                                <li>
                ...
                <div class="row footer-bottom-row">
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <ul class="footer-menu footer-policies list-unstyled">
                            <li>
                                <a href="#" class="text text-16 link" aria-label="Privacy Policy">
                                    Privacy Policy
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="contact.php" class="text text-16 link" aria-label="FAQ">
                                    Contact
                                </a>
                            </li>
                        </ul>
